...
import { Clue, COLOR_LABELS, LAB_HOTSPOTS } from "./gameData";
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
        ...
        {showHint && (
          ...
          >
            <div className="mx-auto max-w-5xl p-3">
              ...
              <div className="mt-2 grid grid-cols-2 gap-1 text-xs font-narrative text-muted-foreground">
                <p>🔴 <strong className="text-clue-red">Vermelho</strong> = Ácidos</p>
                <p>🔵 <strong className="text-clue-blue">Azul</strong> = Bases</p>
                <p>🟡 <strong className="text-clue-yellow">Amarelo</strong> = Sais</p>
                <p>🟢 <strong className="text-clue-green">Verde</strong> = Óxidos</p>
              </div>
            </div>
          </motion.div>
        )}
      ...
      <div className="relative flex-1 overflow-auto">
          ...
          {LAB_HOTSPOTS.map(spot => {
            ...
            return (
              ...
              >
                ...
                {/* Hotspot dot */}
                <div
                  className={`relative z-10 flex h-6 w-6 items-center justify-center rounded-full text-xs transition-all ${
                    isAnswered
                ...
                >
                  {isAnswered ? (
                    ...
                    <span className="text-[10px]">{spot.icon}</span>
                  )}
                </div>
        ...
        {/* Bottom bar with progress and cabinet button */}
        ...
        {activeClue && !activeClue.answered && (
          ...
          >
            ...
            >
              ...
              <p className="font-narrative text-sm leading-relaxed text-foreground mb-4">
                {activeClue.question}
              </p>
              ...
              <AnimatePresence>
                {feedback === "correct" && (
                  ...
                  >
                    <Check className="h-4 w-4" /> Correto! Excelente!
                  </motion.div>
                )}
                {feedback === "wrong" && (
                  <motion.div
